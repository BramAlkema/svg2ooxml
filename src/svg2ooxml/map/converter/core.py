...
from .policy_hooks import PolicyHooksMixin
from .shape_converters import ShapeConversionMixin
from .styles import StyleExtractor
from .text import TextConverter
from .traversal import ElementTraversal
from .traversal_hooks import TraversalHooksMixin
from .hyperlinks import HyperlinkProcessor
from .resvg_clip_mask import collect_resvg_clip_definitions, collect_resvg_mask_info
from .resvg_paint_bridge import describe_linear_gradient, describe_pattern, describe_radial_gradient
...
class IRConverter(PolicyHooksMixin, ShapeConversionMixin, TraversalHooksMixin):
    ...
    def __init__(
        ...
        *,
        ...
        self._style_resolver = style_resolver or StyleResolver(self._unit_converter)
