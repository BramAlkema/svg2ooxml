...
from . import styles_runtime
from .geometry_utils import is_axis_aligned, scaled_corner_radius, transform_axis_aligned_rect

if TYPE_CHECKING:  # pragma: no cover - import guard
    from .coordinate_space import CoordinateSpace
    from .core import IRConverter
...
def convert_rect(
    ...
    *,
    ...
    style = styles_runtime.extract_style(converter, element)
