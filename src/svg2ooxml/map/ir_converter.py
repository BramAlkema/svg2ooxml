"""Public API for converting parser results into IR scenes."""

# TODO(ADR-parser-core): Audit remaining SplitIRConverter behaviours (e.g. hyperlink metadata,
# filter expansion, EMF/raster fallbacks) and port them into IRConverter once policy/map parity lands.
...
from svg2ooxml.map.converter.core import IRConverter, IRScene
...
def _hydrate_services_from_parser(
    ...
    """Ensure DI services pick up parser-collected definitions such as filters and markers."""
