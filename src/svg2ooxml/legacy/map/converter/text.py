...
from .smart_font_bridge import SmartFontBridge
from .text_pipeline import TextConversionPipeline
...
class TextConverter:
    ...
    def convert(self, *, element: etree._Element, coord_space: CoordinateSpace) -> TextFrame | None:
        ...
        self._parent._trace_geometry_decision(element, "native", frame.metadata)
        return frame
