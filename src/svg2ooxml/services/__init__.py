...
_symbol_map = {'ConverterCache': 'cache', 'StructuredClipService': 'clip_service', 'ClipAnalysis': 'clip_service', 'ColorSpaceService': 'color_service', 'ColorNormalizedImage': 'color_service', 'ConversionServices': 'conversion', 'FilterService': 'filter_service', 'FilterEffectResult': 'filter_types', 'BasicSmartFontConverter': 'font_converter', 'build_smart_font_converter': 'font_converter', 'SmartFontConverter': 'font_converter', 'GradientOptimisationPlan': 'gradient_processor', 'GradientComplexity': 'gradient_processor', 'GradientAnalysis': 'gradient_processor', 'GradientProcessor': 'gradient_processor', 'GradientOptimisation': 'gradient_processor', 'GradientMetrics': 'gradient_processor', 'GradientService': 'gradient_service', 'ImageService': 'image_service', 'ImageResource': 'image_service', 'Resolver': 'image_service', 'MarkerService': 'marker_service', 'StructuredMaskService': 'mask_service', 'MaskComputeResult': 'mask_service', 'PatternService': 'pattern_service', 'configure_services': 'setup', 'SymbolService': 'symbol_service'}
