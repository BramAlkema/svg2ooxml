...
_BASE_GEOMETRY: dict[str, Any] = {
    ...
    "simplify_paths": True,
    "simplify_min_segments": 16,
    "bezier_flatness_px": 0.5,
    "collinear_angle_deg": 0.5,
    "rdp_tolerance_px": 1.0,
    "curve_fit_enabled": True,
    "curve_fit_tolerance_px": 1.5,
    "curve_fit_min_points": 8,
    "detect_preset_shapes": True,
    "shape_detect_tolerance_px": 2.0,
...
_LOW_OPTIONS = _policy_template(
    ...
    geometry_overrides={
        ...
        "simplify_paths": True,
        "simplify_min_segments": 8,
        "bezier_flatness_px": 1.0,
        "collinear_angle_deg": 1.0,
        "rdp_tolerance_px": 2.0,
        "curve_fit_tolerance_px": 3.0,
        "curve_fit_min_points": 6,
