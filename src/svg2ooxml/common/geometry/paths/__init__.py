...
_symbol_map = {'to_line_segments': 'drawing', 'approximate_circle': 'drawing', 'approximate_ellipse': 'drawing', 'compute_path_bounds': 'drawingml', 'PathCommand': 'drawingml', 'build_path_commands': 'drawingml', 'parse_path_data': 'parser', 'PathParseError': 'parser', 'tessellate_path': 'resvg_bridge', 'PathTessellation': 'resvg_bridge', 'NormalizedSegments': 'resvg_bridge', 'TessellationOutput': 'resvg_bridge', 'normalize_path_to_segments': 'resvg_bridge', 'compute_segments_bbox': 'segments'}
