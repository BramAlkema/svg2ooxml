"""EMF filter renderer mixins used by :mod:`svg2ooxml.drawingml.emf_adapter`."""
...
if TYPE_CHECKING:
    from svg2ooxml.drawingml.emf_adapter import EMFResult


class EMFAdapterRenderMixin:
    """Render deterministic EMF previews for supported filter primitives."""
