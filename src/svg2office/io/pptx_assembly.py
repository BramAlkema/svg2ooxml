...
from svg2office.drawingml.assets import FontAsset, MediaAsset, NavigationAsset
...
class PPTXPackageBuilder:
    ...
    def __init__(
        ...
        *,
        ...
        self._writer = DrawingMLWriter(
            template_dir=self._assets_root,
    ...
    def build_from_results(
        ...
        *,
        ...
        from svg2office.io.pptx_writer import PackageWriter
    ...
    def begin_streaming(
        ...
        *,
        ...
        from svg2office.io.pptx_writer import StreamingPackageWriter
