...
from svg2office.ir.effects import CustomEffect
from svg2office.ir.geometry import Point, Rect
from svg2office.ir.paint import PatternPaint, RadialGradientPaint, SolidPaint
from svg2office.ir.scene import Group, Image
from svg2office.ir.scene import Path as IRPath
from svg2office.ir.shapes import Circle, Ellipse, Line, Polygon, Polyline, Rectangle
from svg2office.policy.constants import FALLBACK_BITMAP, FALLBACK_RASTERIZE
...
class DrawingMLShapeRenderer:
    ...
    _INVALID_EFFECT_MARKERS = (
        "<a:solidfill",
        "svg2office:sourcegraphic",
        "svg2office:sourcealpha",
        "svg2office:emf",
        "svg2office:raster",
    )
    ...
    def __init__(
        ...
        *,
        ...
        lookup_blip_extensions: Callable[[str], dict[str, object] | None] | None,
        ...
        self._lookup_blip_extensions = lookup_blip_extensions
