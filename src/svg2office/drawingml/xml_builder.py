...
Examples:
    >>> from svg2office.drawingml.xml_builder import solid_fill, to_string
...
from svg2office.common.office_profile import NS_A14, NS_ASVG, NS_MC, NS_P14
...
etree.register_namespace("a14", NS_A14)
etree.register_namespace("asvg", NS_ASVG)
