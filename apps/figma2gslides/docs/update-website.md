...
This guide shows you how to update the figma2gslides hosted website surface.

## Website Files

The website files are located in the `apps/figma2gslides/website/` directory:
- `apps/figma2gslides/website/index.html` - App website homepage
- `apps/figma2gslides/website/privacy.html` - Privacy Policy
- `apps/figma2gslides/website/terms.html` - Terms of Service

## Method 1: Edit Files and Deploy (Recommended)

### Step 1: Edit the Website Files

Edit any files in the website directory:

```bash
# Edit homepage
vim apps/figma2gslides/website/index.html

# Edit privacy policy
vim apps/figma2gslides/website/privacy.html

# Edit terms of service
vim apps/figma2gslides/website/terms.html
```
...
# Commit changes
git add apps/figma2gslides/website/
...
1. Create a new HTML file in `apps/figma2gslides/website/` (e.g., `apps/figma2gslides/website/about.html`)
...
3. Firebase CLI deploys the `apps/figma2gslides/website/` directory to Firebase Hosting
...
Check:
1. File exists in `apps/figma2gslides/website/` directory
...
- See `apps/figma2gslides/website/index.html` for the homepage structure
- See `apps/figma2gslides/website/privacy.html` for the privacy policy
- See `apps/figma2gslides/website/terms.html` for the terms of service
- Customize styling by editing the `<style>` sections
- Add new pages by creating new HTML files in `apps/figma2gslides/website/`
