...
**Outputs**:
- `firebase-web-config.json` (save to docs/reference/setup/)
...
**File**: `src/figma2gslides/api/auth/firebase.py`
...
**File**: `src/figma2gslides/api/auth/encryption.py`
...
**File**: `src/figma2gslides/api/auth/middleware.py`
...
**File**: `src/figma2gslides/api/routes/export.py`
...
**File**: `src/figma2gslides/api/services/export_service.py`
...
**File**: `src/figma2gslides/api/background/tasks.py`
...
**File**: `src/figma2gslides/api/routes/tasks.py`
...
**File**: `apps/figma2gslides/figma-plugin-firebase-auth.md`
