...
**Spec**: Historical app plan; no standalone browser-auth spec has been restored yet.
**Status**: Not Started
...
**Files**:
- `apps/figma2gslides/website/test-db.html` (temporary test file)
...
- [ ] Create `apps/figma2gslides/website/auth.html`
...
**Files**:
- `apps/figma2gslides/website/auth.html` (new)

---

### Task 2.2: Implement OAuth Logic
- [ ] Create `apps/figma2gslides/website/auth.js`
...
**Files**:
- `apps/figma2gslides/website/auth.js` (new)
...
**Files**:
- `apps/figma2gslides/website/auth.js` (update)
...
- [ ] Create `apps/figma2gslides/website/auth-status.html`
...
**Files**:
- `apps/figma2gslides/website/auth-status.html` (new)

---

### Task 3.2: Implement Token Retrieval Logic
- [ ] Create `apps/figma2gslides/website/auth-status.js`
...
**Files**:
- `apps/figma2gslides/website/auth-status.js` (new)
...
- [ ] Update `apps/figma2gslides/figma-plugin/ui.js`
...
**Files**:
- `apps/figma2gslides/figma-plugin/ui.js` (update)
...
- [ ] Review `apps/figma2gslides/figma-plugin/manifest.json`
...
**Files**:
- `apps/figma2gslides/figma-plugin/manifest.json` (update)
...
- [ ] Update `apps/figma2gslides/figma-plugin/README.md`:
  - Add "Browser Support" section
  - Explain both auth flows
  - Update requirements (remove "Desktop only")
- [ ] Update `apps/figma2gslides/figma-plugin/QUICKSTART.md`:
  - Remove desktop-only warnings
  - Add browser-specific instructions
  - Update troubleshooting
- [ ] Update `apps/figma2gslides/figma-plugin-firebase-auth.md`:
...
**Files**:
- `apps/figma2gslides/figma-plugin/README.md` (update)
- `apps/figma2gslides/figma-plugin/QUICKSTART.md` (update)
- `apps/figma2gslides/figma-plugin-firebase-auth.md` (update)
...
**Documentation**:
- Spec: historical browser-auth plan; promote to an app spec before implementation
