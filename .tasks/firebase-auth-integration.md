...
**Spec**: [docs/specs/firebase-auth-google-slides-export.md](../docs/specs/firebase-auth-google-slides-export.md)
**Status**: 🔴 Not Started
...
**Acceptance Criteria**:
- [ ] Web app registered
- [ ] Config object saved to `docs/setup/firebase-web-config.json`

**Outputs**:
- `docs/setup/firebase-web-config.json` with:
  ```json
  {
    "apiKey": "...",
...
**File to Create**: `src/svg2ooxml/api/auth/firebase.py`

**Implementation**: See detailed code in `docs/tasks/firebase-auth-implementation-tasks.md` Task 2.2
...
**Acceptance Criteria**:
- [ ] File created at `src/svg2ooxml/api/auth/firebase.py`
...
**File to Create**: `src/svg2ooxml/api/auth/encryption.py`

**Implementation**: See detailed code in `docs/tasks/firebase-auth-implementation-tasks.md` Task 2.3
...
**Acceptance Criteria**:
- [ ] File created at `src/svg2ooxml/api/auth/encryption.py`
...
**File to Create**: `src/svg2ooxml/api/auth/middleware.py`

**Implementation**: See detailed code in `docs/tasks/firebase-auth-implementation-tasks.md` Task 2.4

**Functions**:
- `verify_firebase_token()` - FastAPI dependency for token verification

**Acceptance Criteria**:
- [ ] File created at `src/svg2ooxml/api/auth/middleware.py`
...
**File to Modify**: `src/svg2ooxml/api/routes/export.py`
...
**File to Modify**: `src/svg2ooxml/api/services/export_service.py`
...
**File to Modify**: `src/svg2ooxml/api/services/slides_publisher.py`
...
**Review Documents**:
- [ ] `docs/specs/firebase-auth-google-slides-export.md` - Accurate?
- [ ] `docs/tasks/firebase-auth-implementation-tasks.md` - Up to date?
- [ ] `docs/guides/figma-plugin-firebase-auth.md` - Clear instructions?
