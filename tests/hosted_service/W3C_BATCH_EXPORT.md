...
python tests/hosted_service/batch_export_w3c.py --limit 5
```

### Full Export (All 525 files)

```bash
python tests/hosted_service/batch_export_w3c.py \
  --batch-size 10 \
  --delay 15
```
...
```bash
python tests/hosted_service/batch_export_w3c.py --delay 30
```
...
- [Testing guide](../../docs/testing.md) - Current test tiers and workflows
- [Corpus guide](../corpus/README.md) - Corpus layout and execution notes
